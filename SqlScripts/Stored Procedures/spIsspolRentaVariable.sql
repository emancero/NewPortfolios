...
PRECIO_INFO_BASICA=1.0
  ...
  group by  TVL_NOMBRE,CUENTA_CONTABLE,VECTOR_PRECIO,TIPO,CUPON,PLAZO_PACTADO,FECHA_VENCIMIENTO_CONVENIO_PAGO,FECHA_SUSCRIPCION_CONVENIO_PAGO,FECHA_VENCIMIENTO_ORIGINAL,EMISOR,INTERVINIENTES,PRECIO_DE_HOY,VENCER,FECHA_VALOR_DE_COMPRA,YIELD,PRECIO,SECTOR
  ,MONTO_EMITIDO,PATRIMONIO,CALIFICADORA_DE_RIESGO,CALIFICACION_DE_RIESGO,FECHA_DE_PAGO_ULTIMO_CUPON,DIAS_DE_INTERES_GANADO,PCT_A_AJUSTAR,DIAS_POR_VENCER_A_LA_COMPRA,PCT_AJUSTE_DIARIO,FACTOR_DE_AJUSTE,CONTROLADOR_SECTOR,CONTROLADOR_POSICION
  ,PRECIO_ULTIMA_COMPRA,FECHA_ULTIMA_COMPRA,BASE_PARA_DIAS_INTERES,BASE_PARA_TASA_INTERES,VECTOR_PRECIO2,CUPON_VECTOR,CODIGO_TITULO,TIPO_VECTOR,ACCIONES_REALIZADAS,MANTIENE_VECTOR_PRECIO,ACP_ID,PROG,ACTA,GCXC_NOMBRE,TVL_CODIGO,EMS_NOMBRE,TPO_F1,OTROS_COSTOS,TPO_PROG,RECURSOS,
