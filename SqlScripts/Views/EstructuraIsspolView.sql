CREATE view BVQ_BACKOFFICE.EstructuraIsspolView as
	...
	--drop table _temp.pc
		...
		,TPO_COMISION_BOLSA
		,INTERES_GANADO_2
		from bvq_backoffice.LiquidacionAReportar
		--having 1=0
		union all
	...
	left join (
		...
		left join bvq_administracion.casa_valores cva on iif(opc.OPC_ABR_CAS_VAL='MDF','ISP',opc.OPC_ABR_CAS_VAL)=CVA.CVA_SIGLAS
